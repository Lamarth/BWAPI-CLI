...
namespace BWAPI
{
  ...
  public:
    ...
    Unitset getUnitsInRadius(int radius, const UnitFilter &pred = Filter::IsTransport) const;
    ...
    Unitset getUnitsInWeaponRange(WeaponType weapon, const UnitFilter &pred = Filter::IsTransport) const;
    ...
    Unit getClosestUnit(const UnitFilter &pred = Filter::IsTransport, int radius = 999999) const;
